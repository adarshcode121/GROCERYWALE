...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $name = $_POST['firstname']; // Changed from 'firstname' to 'name'
    $email = $_POST['email'];
    $address = $_POST['address'];
    $password = $_POST['password'];
    $hashed_password = password_hash($password, PASSWORD_DEFAULT);

    $query = "INSERT INTO admin (name, email, password, address) 
...
<body>
    ...
    <div class="reg-container">
        <h2>Register/<a href="../admin/admin-login.php">Login</a></h2>
        <?php echo $UserError ? "<h1 class='errorText'>Some Error!</h1>" : ""; ?>
        <?php echo $UserError1 ? "<h1 class='errorText'>Registration successful! Please log in.</h1>" : ""; ?>
