...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark px-3">
        <a class="navbar-brand fw-bold text-white" href="index.php"><em><img id="logo" src="Nav/logo5.png" alt="Logo" /></em></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="ms-auto d-flex align-items-center flex-column flex-lg-row mt-3 mt-lg-0">
                ...
                <a href="#" class="nav-item mx-3">Grocery</a>
